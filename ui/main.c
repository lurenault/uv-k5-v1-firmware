...
# ifdef ENABLE_DTMF_CALLING
				...
				// Print bottom string in call info
				if (!gDTMF_InputMode) {
					if (gDTMF_CallState == DTMF_CALL_STATE_CALL_OUT) {
						...
						sprintf(String, "%s", (DTMF_FindContact(gDTMF_Caller, Contact)) ? Contact : gDTMF_Caller);
						pPrintStr = String;
					}else if (gDTMF_IsTx) {
